  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case VistaenviosRow:
            return VistaenviosRow(data);
          case AsignacionpedidosrepartidoresRow:
            return AsignacionpedidosrepartidoresRow(data);
          case PedidosRow:
            return PedidosRow(data);
          case DetallespedidoRow:
            return DetallespedidoRow(data);
          case RepartidoresRow:
            return RepartidoresRow(data);
          case UsuariosRow:
